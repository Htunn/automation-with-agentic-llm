...
function show_usage() {
    echo "Usage: $0 {setup|start|stop|restart|test|test-integration|test-windows|test-linux|linux-automation|linux-security|shell|logs|model|clean}"
    echo ""
    echo "Commands:"
...
case "$1" in
  ...
  test-linux)
    ...
    sleep 20
    echo "Running Linux test playbook..."
